...
<div style="background-color: #f4ebfc; margin: 5px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="0"> 
...
<div style="background-color: #f0faff; margin: 5px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="1"> 
...
<div style="background-color: #f4ebfc; margin: 5px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="2"> 
