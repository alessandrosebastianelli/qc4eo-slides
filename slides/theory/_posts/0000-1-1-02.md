...
<div style="background-color: #E6F7FF; padding: 10px; border: 2px solid black;  border-radius: 10px; opacity: 0.5;" class="fragment" data-fragment-index="0"> 
...
<div style="background-color: #E6F7FF; padding: 10px; border: 2px solid black;  border-radius: 10px; opacity: 0.5;" class="fragment" data-fragment-index="1"> 
...
<div style="background-color: #E6F7FF; padding: 10px; border: 2px solid black;  border-radius: 10px; opacity: 0.5;" class="fragment" data-fragment-index="2"> 
