...
<div style="background-color: #f9f5fc; padding: 10px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="0"> 
...
<div style="background-color: #f5fafc; padding: 10px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="1"> 
...
<div style="background-color: #f9f5fc; padding: 10px; border: 2px solid black;  border-radius: 10px;" class="fragment fade-in" data-fragment-index="2"> 
