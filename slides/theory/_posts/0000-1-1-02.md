...
<div class="r-stack">
  <div>
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQI_uZ5r8vQDsnNWXB2xUcYTL1ee21emlwnmdsAoLKyxzgTMfu9ptcRMGfF40VEXpsCB2M&usqp=CAU" width="300" height="450" class="fragment fade-in-then-out">
    <p>IBM</p>
  </div>
  <div>
    <img src="https://www.thequantuminsider.com/wp-content/uploads/2020/03/Rigetti-225x300.jpeg" width="300" height="450" class="fragment fade-in-then-out">
    <p>Rigetti</p>
  </div>
  <div>
    <img src="https://miro.medium.com/v2/resize:fit:1358/1*I4eFFZbTdmNF0b16AbRtFA@2x.jpeg" width="300" height="450" class="fragment fade-in-then-out">
    <p>Google</p>
  </div>
</div>
