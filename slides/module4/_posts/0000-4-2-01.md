...
### w14.1.1 - What are kernel methods? (1) <!-- .element: class="r-fit-text" -->
...
### w14.1.1 - What are kernel methods? (2) <!-- .element: class="r-fit-text" -->
...
### w14.1.1 - What are kernel methods? (3) <!-- .element: class="r-fit-text" -->
